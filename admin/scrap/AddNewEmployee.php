...
{			
	...
	if(isset($_FILES["flPage"]) && $_FILES["flPage"]['name'] != "")
	{
		...
		EmailAddress='".dbinput($EmailAddress)."'") or die(mysql_error());
	...
	if($msg=="")
	{
		...
		$query="INSERT INTO employee_users SET DateAdded=NOW(),
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="LocationID" id="LocationID" required="required" class="form-control">
							...
							{
								echo '<option value="0">Location Not Found! (Add Location Before Create Any Employee)</option>';
							}

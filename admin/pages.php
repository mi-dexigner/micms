  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
		...
		<?php 
		$query="SELECT p.id,p.title,p.slug,p.body, CONCAT(u.FirstName,' ' ,u.LastName) AS FullName,DATE_FORMAT(created_at, '%D %b %Y<br>%r') AS Added,DATE_FORMAT(created_updated, '%D %b %Y<br>%r') AS Updated FROM posts p LEFT JOIN users u  ON u.ID = p.userId WHERE p.id <> 0 AND p.post_type = 'pages' AND p.status = 1 ORDER BY id DESC  ";
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Pages <small>Users who manage this panel</small></h3>
              </div>
                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a href="AddNewPages.php" class="btn btn-default active"><i class="fa fa-plus-square"></i> Add New</a></li>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap bulk_action" cellspacing="0" width="100%">
                      ...
                      <tbody>
						...
						?>
								<tr class="noPrint">
								  <td colspan="11" align="center" class="error"><b>No Pages listed.</b></td>
								</tr>
							<?php
							}
							else
                        ...
                        <tr>
						  ...
						  <td><?php echo dboutput($row["FullName"]); ?></td>
						  <td><?php echo $row["Added"]; ?></td>
						  <td><?php echo $row["Updated"]; ?></td>
						  <td align="center" class="noPrint">
						  	<button class="btn bg-navy btn-xs" type="button" onClick="location.href='EditPages.php?ID=<?php echo $row["id"]; ?>'"><i class="fa fa-pencil"></i></button>

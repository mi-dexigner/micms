...
if(isset($_POST['submit']) && $_POST['submit']){
  ...
  $heading_id = db_escape($db,$_POST['heading_id']);
	...
	if($name == "")
	 ...
	 echo $insertPage = "INSERT INTO rows (name, status, col1,col2,user,heading_id) VALUES ('$name', $status, '$col1','$col2','$user','$heading_id')";
...
<html lang="en">
  ...
  <input type="text" name="col2" id="col2" class="form-control" />
   ...
   <div class="form-group item">
  <label for="heading_id" class="control-label col-md-3 col-sm-3 col-xs-12">Heading Name</label>
  <div class="col-md-6 col-sm-6 col-xs-12">

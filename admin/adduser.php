...
if(isset($_POST["action"]) && $_POST["action"] == "submit_form")
{
	...
	if(isset($_FILES["flPage"]) && $_FILES["flPage"]['name'] != "")
	{
		...
		EmailAddress='".dbinput($EmailAddress)."'") or die(mysqli_error());
	...
	if($msg=="")
	{
		...
		$query="INSERT INTO users SET DateAdded=NOW(),
                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
					  <li><a href="users.php" class="btn btn-default active"><i class="fa fa-arrow-left"></i> Back</a></li>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
				  <?php

...
if(isset($_POST['submit']) && $_POST['submit']){
  ...
  $head_id = db_escape($db,$_POST['head_id']);
	...
	if($name == "")
	 ...
	 $insertPage = "INSERT INTO  heading (name, status, col1,col2,user,head_id) VALUES ('$name', $status, '$col1','$col2','$user','$head_id') ";
	...
	if($result){
		...
		<i class="fa fa-ban"></i>
		<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
		<b>Page Heading has been added.</b>
		</div>';
		...
		<i class="fa fa-ban"></i>
		<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
		<b>Page Heading has not be added.</b>
		</div>';
	redirect("Heading.php");
...
<html lang="en">
  <head>
    ...
    <title>Add New Page Heading</title>

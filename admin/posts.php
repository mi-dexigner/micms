          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Posts <small>Users who manage this panel</small></h3>
              </div>
                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a href="AddNewPost.php" class="btn btn-default active"><i class="fa fa-plus-square"></i> Add New</a></li>
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap bulk_action" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
						  ...
						  <td align="center" class="noPrint">
						  	<button class="btn bg-navy btn-xs" type="button" onClick="location.href='EditPosts.php?ID=<?php echo $row["id"]; ?>'"><i class="fa fa-pencil"></i></button>
